...
func encodeAuthGoogleCallbackResponse(response AuthGoogleCallbackRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *AccessTokenHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.Header().Set("Access-Control-Expose-Headers", "Set-Cookie")
	...
	case *AuthGoogleCallbackBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *AuthGoogleCallbackUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
		span.SetStatus(codes.Error, http.StatusText(401))
	...
	case *AuthGoogleCallbackInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
	...
	case *AuthGoogleCallbackGatewayTimeout:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(504)
		span.SetStatus(codes.Error, http.StatusText(504))
...
func encodeAuthGoogleLoginResponse(response AuthGoogleLoginRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *AuthGoogleLoginInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
	...
	case *AuthGoogleLoginGatewayTimeout:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(504)
		span.SetStatus(codes.Error, http.StatusText(504))
